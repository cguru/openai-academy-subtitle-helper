...
기본 대상 언어는 한국어입니다. 이전 CLI 흐름인 `translate.bat`도 기본적으로 한국어 자막을 생성합니다.
...
이전 CLI 방식도 사용할 수 있습니다. 이 명령은 기본적으로 한국어 자막을 생성합니다.
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\New-AcademyKoreanSubtitle.ps1 `
